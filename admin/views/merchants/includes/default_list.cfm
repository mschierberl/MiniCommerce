...
<div class="section clearfix">
	<table class="ms-datatable display hideTable" id="ms-datatable"
		data-url="#rc.$.globalConfig().getContext()#/plugins/#local.rc.pluginConfig.getDirectory()#/com/meldsolutions/meldminicommerce/remote/MeldMiniCommerceRemoteAOP.cfc?method=getMerchantList&data&returnFormat=json">
		<thead class="headers">
		<tr>
			<th class="nosort nopad ui-state-active" data-class="nopad">&nbsp;</th>
			<th class="varWidth ui-state-active">#rc.mmRBF.key('name')#</th>
			<th class="minWidth ui-state-active" data-class="center">#rc.mmRBF.key('iscurrent')#</th>
		</tr>
		</thead>
		...
		<tr>
			...
			<th>
			<select class="select" name="isCompleted" id="flt_iscurrent" data-column="iscurrent">
