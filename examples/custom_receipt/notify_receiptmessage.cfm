<!--- 
	Note that the receiptmessage.cfm and notifymessage.cfm are sent out via Email, and as such
	the document should contain at least basic CSS styling
 --->
<cfsilent>
<!---
	AVAILABLE
...
<p>Thank you for your purchase, #userBean.getFname()# #userBean.getLname()#.</p>
